...
export default function FAQ() {
    ...
    return (
        <section id="faq" className="h-screen min-h-[820px] bg-[#F3F2EF] flex items-start pt-[9vh] md:pt-[11vh]">
            <div className="max-w-6xl mx-auto px-4 md:px-6 w-full">
                ...
                <div className="mt-8 md:mt-10 p-5 md:p-7 bg-dark rounded-[1.6rem] relative z-20 border border-white/12 shadow-[0_22px_48px_rgba(1,7,18,0.45)] overflow-hidden">
                    ...
                    <div className={`relative z-10 flex flex-col lg:flex-row items-stretch justify-between gap-5 md:gap-7 min-h-[170px] md:min-h-[190px] ${isArabic ? 'lg:flex-row-reverse' : ''}`}>
                        <div className={`flex-1 ${isArabic ? 'text-right items-end lg:pr-1' : 'text-left items-start lg:pl-1'} flex flex-col justify-center`}>
                            ...
                            <p className="text-white/78 mb-4 text-sm md:text-base max-w-[44ch]">
                                {language === 'en'
                        ...
                        <div className="w-full lg:w-[330px] shrink-0 lg:self-stretch">
                            <div className="h-full min-h-[160px] md:min-h-[180px] rounded-2xl border border-white/80 bg-[linear-gradient(145deg,rgba(255,255,255,0.97),rgba(242,247,255,0.92))] shadow-[0_12px_28px_rgba(2,10,24,0.35)] overflow-hidden">
                                <img
                                    src="/thumbsup.webp"
                                    alt={language === 'en' ? 'Thumbs up illustration' : 'رسم إبهام لأعلى'}
